...
const ProductCard = ({
  ...
  const priceBorderClass = priceBorderStyle === 'white' ? 'border-white' : 'border-lightGray';
  const originalPriceClass = originalPriceStyle === 'white' ? 'text-white' : 'text-lightGray';
